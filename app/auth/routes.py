...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash(_('Check your email for the instructions to reset your password'))  # To prevent brute-forcing on the username
        return redirect(url_for('auth.login'))
    return render_template('auth/reset_password_request.html',
                           title='Initiate Reset Password', form=form)
...
def reset_password(token):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('auth.login'))
    return render_template('auth/email/reset_password.html', title='Reset Password', form=form)
